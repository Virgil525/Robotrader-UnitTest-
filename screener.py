...
class Stock:
    def __init__(self, symbol, sector, market_cap, dividend_yield, pe_ratio, performance_52_week, obv, adx, average_volume_10day,macd,macd_signal,macd_buy, new_high, number_of_new_highs, macd_hist_data, total_score):
        self.symbol = symbol
        self.sector = sector
...
class StockScreenerApp(QMainWindow):
    ...
    def create_widgets(self):
        ...
        self.tree.setHorizontalHeaderLabels(["Symbol", "Sector", "Market Cap(in millions)", "Dividend Yield", "P/E Ratio", "52-Week Performance","MinimumAverage10DayVolume","On Balance Value","Min average directional index","MACD","Number of New Highs in Date Range","macd buy signal (in the most recent trading session)","MACD Histogram", "Weighted Score"])
...
class LoadingThread(QThread):
    ...
    def get_stock_data(self, symbol, start_date=None, end_date=None):
        ...
        if any(v is None for v in variables):
            ...
            return None
        return Stock(symbol, sector, market_cap, dividend_yield, pe_ratio, performance_52_week, obv, adx, average_volume_10day, macd, signal, macd_buy, is_new_high, number_of_new_highs, hist, total_score)
